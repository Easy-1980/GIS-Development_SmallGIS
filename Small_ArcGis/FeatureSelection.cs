...
namespace Small_ArcGis
{
    public partial class FormSelection : Form
    {
        ...
        private void FeatureSelection_Load(object sender, EventArgs e)
        {
            ...
            string layerName;       // 设置临时变量存储当前图层名称
            ...
            // 添加完节点后，将根节点展开以显示所有图层
            treeViewLayers.TopNode.Expand();
            // 通过IMap接口的SelectionCount属性获取被选择要素的数量
        ...
        private void treeViewLayers_MouseClick(object sender, MouseEventArgs e)
        {
        ...
        private void treeViewLayers_NodeMouseClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            try
            {
                ...
                // 通过接口跳转，使用IFeatureSelection接口获取图层的选择集
                ...
                // 对当前图层要素的属性字段进行遍历，建立DataGridView中的列
                // 同时获取所有属性字段
        ...
        // 在列表中点击某一行时执行，将主窗体的地图定位到该行所表示的要素范围
        private void dataGridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            // 获取当前锁电机的行
            DataGridViewRow row = dataGridView.Rows[e.RowIndex];
            // 每行的第一列时要素的ObjectID，获取该信息
